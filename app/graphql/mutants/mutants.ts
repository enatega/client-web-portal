...
export const saveEmailConfiguration = gql`
  mutation SaveEmailConfiguration(
...
`;
export const saveFormEmailConfiguration = gql`
  mutation SaveFormEmailConfiguration(
...
`;
export const saveSendGridApiKey = gql`
  mutation SaveSendGridApiKey(
...
export const saveSentryConfiguration = gql`
  mutation SaveSentryConfiguration(
...
`;
export const saveCloudinaryConfiguration = gql`
  mutation SaveCloudinaryConfiguration(
...
`;
export const saveGoogleClientIDConfiguration = gql`
...
`;
export const saveDeliveryRateConfiguration = gql`
  mutation SaveDeliveryRateConfiguration(
...
export const savePaypalConfiguration = gql`
  mutation SavePaypalConfiguration(
...
export const saveStripeConfiguration = gql`
  mutation SaveStripeConfiguration(
...
export const saveTwilioConfiguration = gql`
  mutation saveTwilioConfiguration(
...
export const saveVerificationToggles = gql`
  mutation SaveVerificationsToggle(
...
export const saveCurrencyConfiguration = gql`
  mutation SaveCurrencyConfiguration(
...
export const editOffer = gql`
  mutation EditOffer($offer: OfferInput!) {
...
export const createOptions = gql`
...
export const createTipping = gql`
...
export const createTaxation = gql`
  mutation CreateTaxation($taxationInput: TaxationInput!) {
...
export const editTaxation = gql`
  mutation editTaxation($taxationInput: TaxationInput!) {
...
export const vendorResetPassword = gql`
...
export const updateTimings = gql`
...
export const updateDeliveryBoundsAndLocation = gql`
...
export const updateWithdrawReqStatus = gql`
