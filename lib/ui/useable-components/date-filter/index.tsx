...
export default function DashboardDateFilter({ dateFilter, setDateFilter }: IDashboardDateFilterComponentsProps) {
    ...
    const onApply = () => {
        ...
        if (
            (dateFilter.startDate === localDateFilter.startDate && dateFilter.endDate === localDateFilter.endDate)) {
            return;
        }
                ...
                <div className="flex flex-col md:flex-row justify-between items-center p-4 space-y-4 md:space-y-0 md:space-x-4">
                    <div className="flex flex-col w-full">
                        ...
                        <div className="relative">
                            <CustomDateInput value={localDateFilter?.startDate ?? ""} onChange={(value) => setLocalDateFilter({ ...localDateFilter, startDate: value })} />
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="relative">
                            <CustomDateInput value={localDateFilter?.endDate ?? ""} onChange={(value) => setLocalDateFilter({ ...localDateFilter, endDate: value })} />
                            <FontAwesomeIcon icon={faCalendarAlt} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                        </div>
                    </div>
