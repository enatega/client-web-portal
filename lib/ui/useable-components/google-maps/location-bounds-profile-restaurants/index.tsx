...
const UpdateRestaurantLocationBounds: React.FC<
  ICustomGoogleMapsLocationBoundsComponentProps
> = ({ onStepChange }) => {
  // Context
  ...
  // NEW: State to store all restaurants and their locations
  ...
  function onRestaurantProfileFetchCompleted({
    ...
    setPath(
      restaurant?.deliveryBounds
        ? transformPolygon(restaurant?.deliveryBounds?.coordinates)
        : path
    );
  }
...
export default UpdateRestaurantLocationBounds;
