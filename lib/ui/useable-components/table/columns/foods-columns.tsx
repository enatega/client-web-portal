import { /* IActionMenuProps, */ IActionMenuProps, IFoodGridItem } from '@/lib/utils/interfaces';
...
export const FOODS_TABLE_COLUMNS = ( {
  ...
  return [
    ...
    { headerName: 'Image', propertyName: 'image', body: (item: IFoodGridItem) => {
      console.log({item})
      return item.image ? <Image src={item.image} width={40} height={40} alt="item.png"/> : <></>
    } },
     {
